...
<body id="body-pd">
    {{-- <div class="header" >
        <div class="header_toggle" id="toggle_btn"> <i class='bx bx-menu' ></i> </div>
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    </a> <a href="#" class="nav_link"> <i class='bx bx-bar-chart-alt-2 nav_icon'></i> <span class="nav_name">Stats</span> </a> </div>
