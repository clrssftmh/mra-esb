...
use app\app\Livewire\ChannelIdsComponent;
...
// Route::get('/channels', ChannelIdsComponent::class)->name('channels');
Route::get('channels/{channel:channel_name}', [ChannelController::class, 'show'])->name('posts.channelshow');
